  ...
  printf("offsetof(data) = %d\n", 
	 (int) offsetof(struct req_pkt, data));
  ...
  printf("offsetof(data) = %d\n", 
	 (int) offsetof(struct resp_pkt, data));
  printf("\n");
  ...
  printf("offsetof(lasttime) = %d\n", 
	 (int) offsetof(struct info_monitor_1, lasttime));
  printf("offsetof(firsttime) = %d\n", 
	 (int) offsetof(struct info_monitor_1, firsttime));
  ...
  printf("offsetof(lasttime) = %d\n", 
	 (int) offsetof(struct info_monitor, lasttime));
  printf("offsetof(firsttime) = %d\n", 
	 (int) offsetof(struct info_monitor, firsttime));
  printf("offsetof(restr) = %d\n", 
